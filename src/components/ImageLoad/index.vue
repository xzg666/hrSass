...
const cos = new COS({
  ...
  SecretId: 'AKIDBBwRfcJjriJeiW5NO9drob8PP9cokPnv', // 身份识别 ID
  SecretKey: 'tVqujGWVDeoiLiodBYfV4UeW7RVIo32k' // 身份密钥
})
export default {
  data() {
    return {
      ...
      if (params.file) {
        ...
        //   console.log(err || data)
          ...
          if (!err && data.statusCode === 200) {
            ...
            console.log(data,this.currentFileUid,this.fileList)
          }
        })
      }
    }
